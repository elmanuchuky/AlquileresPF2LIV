...
public class VMSpDatosPuestosAlquilados {
   ...
   int Piso;
    ...
    public VMSpDatosPuestosAlquilados() {
    }

    public VMSpDatosPuestosAlquilados(int Piso, int Cantidad_de_computadoras, String Cantidad_de_sillas, String Tiene_ventana, String Tiene_acesso_a_sala_de_reuniones, int Precio_mensual, String fecha_de_alquiler) {
        this.Piso = Piso;
        this.Cantidad_de_computadoras = Cantidad_de_computadoras;
        this.Cantidad_de_sillas = Cantidad_de_sillas;
        this.Tiene_ventana = Tiene_ventana;
